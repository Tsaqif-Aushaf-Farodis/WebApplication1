...
namespace WebApplication1.ServiceReference1 {
    ...
    public interface IService1 {
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IService1/multipi", ReplyAction="http://tempuri.org/IService1/multipiResponse")]
        double multipi(double num1, double num2);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IService1/multipi", ReplyAction="http://tempuri.org/IService1/multipiResponse")]
        System.Threading.Tasks.Task<double> multipiAsync(double num1, double num2);
    ...
    public partial class Service1Client : System.ServiceModel.ClientBase<WebApplication1.ServiceReference1.IService1>, WebApplication1.ServiceReference1.IService1 {
        ...
        public double multipi(double num1, double num2) {
            return base.Channel.multipi(num1, num2);
        }
        
        public System.Threading.Tasks.Task<double> multipiAsync(double num1, double num2) {
            return base.Channel.multipiAsync(num1, num2);
        }
